...
<html lang="en">
  <head>
    ...
    <title>Movie Bookmark Application - Favourites</title>
    <!-- Favicon-->
...
$sql = $dbh->prepare("SELECT * FROM movies WHERE user_id = :ui and listing_type=1");
 ...
 while($row=$sql->fetch()) 
 {
    ...
    <div class="info">
        ...
        <div class="action_container">
            <a href="link" id="isFavourite"><i class="is_favourite fa fa-heart"></i></a>
